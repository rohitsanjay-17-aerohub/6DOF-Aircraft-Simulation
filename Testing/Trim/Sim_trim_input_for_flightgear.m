%% INPUT DATA
%mass = 1000kg, KCAS = 90 for cessna testing.
%mass = 11000Kg, cg = 0.47,Alt_ft = 41000ft, KCAS = 170 for Executive
%jet(high speed testing)
%mass = 18000Kg,cg =0.3, KCAS = 200 for low initialisation(general testing).
mass = 18000;  
cg = 0.3;
Alt_ft = 4000;
KCAS = 200;
...
% xInitial = getstatestruct(op);       % Save trimmed states
% Throttle = op.Inputs(6).u;           % Save trimmed throttle if floating
% 
% assignin('base', 'xInitial', xInitial);
% assignin('base', 'Throttle', Throttle);  % Only if Throttle = -1
