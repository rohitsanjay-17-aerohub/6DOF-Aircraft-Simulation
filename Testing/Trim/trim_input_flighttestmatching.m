%Input from Flight Test Data
%% FLIGHT DATA (mass = 10886 / cg = 0.34 / KCAS = 240 / Alt = 35000ft - init_high)
mass = 10886;          % Mass is defined based on aircraft
cg = 0.34;              % 34% of MAC(Mean aerodynamic chord)
KCAS = 240;            % Speed is defined
Gamma_deg = 0;         % Trajectory Angle is zero
Phi_deg = 0;           % Bank Angle for turns
Alt_ft = 35000;        % Altitude is defined
