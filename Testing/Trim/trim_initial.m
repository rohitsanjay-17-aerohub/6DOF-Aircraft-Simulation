%Input for Longitudinal Steady State Trim(Level Flight)

mass = 15000;          % Mass is defined based on aircraft
cg = 0.4;              % 40% of MAC(Mean aerodynamic chord)
KCAS = 300;            % Speed is defined
Gamma_deg = 0;         % Trajectory Angle is zero
Phi_deg = 30;           % Bank Angle for turns
Alt_ft = 25000;        % Altitude is defined
Throttle = -1;         % I want it to float if throttle is -1
...
%
% Generated on: 09-Jun-2025 19:26:12
...
% State (11) - ACFT/EqM/InertialData/YI_m
% - Default model initial conditions are used to initialize optimization.
...
% Output (10) - ACFT/p_deg
% - Default model initial conditions are used to initialize optimization.

% Output (11) - ACFT/q_deg
% - Default model initial conditions are used to initialize optimization.

% Output (12) - ACFT/r_deg
% - Default model initial conditions are used to initialize optimization.
